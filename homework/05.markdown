...
This assignment will cover storing and retrieving data in a database as well as in an in-memory session store. You will:
...
You'll create a single express application
...
* once you're connected with a commandline client (mongo), start inserting documents into a database called <code>hw05</code> and a collection called <code>reviews</code>:
  ...
  * so to insert, just do this in the commandline client: <code>db.reviews.insert({ courseNumber: "6087-22", courseName: "AIT", semester: "Fall", year: 2018, professor: "Professor V", review: "best course ever!" });</code>
...
(6087-22), AIT, Spring, 2018, Professor V, "The course was intense and our professor was funny so things balanced out."
(6087-33), Intro To Computer Programming, Fall, 2018, Professor K, "OMG you have to take this course"
</code></pre>
